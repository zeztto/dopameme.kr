...
<div align="center">
  ...
  <p>정치, 경제, 스포츠, 연예 등 실세계 이벤트를 예측하고 도파밈(DPMMM) 포인트를 획득하세요</p>
</div>
...
- 🎯 **게임용 포인트 시스템**: 도파밈(DPMMM) 포인트로 부담 없이 즐기는 예측 게임
...
- 로그인 후: DPMM 포인트 표시 + "내 활동" 버튼 + "로그아웃" 버튼
...
**users 테이블**
- id, name, email, password, image, role, dpmmBalance
- Google OAuth 지원
